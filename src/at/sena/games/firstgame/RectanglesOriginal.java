...
public class RectanglesOriginal extends BasicGame {
    private float x;
    private float y;
    ...
    public RectanglesOriginal(String title) {
        super(title);
    }
    ...
    public static void main(String[] argv) {
        try {
            AppGameContainer container = new AppGameContainer(new RectanglesOriginal("Rectangles"));
